      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
              ...
              {AVAILABLE_MODELS.map((model) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <div className="text-xs text-gray-400 dark:text-gray-500 mt-2 font-mono bg-gray-100 dark:bg-gray-700/50 px-3 py-1.5 rounded-lg inline-block">
                      {model.id}
                    </div>
                  </div>
                </label>
        ...
        <div className="mt-8 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-xl p-6">
          ...
          <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
            <li>
              <strong>1. 获取 API Key：</strong>访问 OpenRouter
              网站注册账号并获取 API Key
            </li>
            <li>
              ...
              <ul className="ml-4 mt-1 space-y-1">
                ...
                <li>
                  • Gemini 3 Flash Preview：最新的高速模型，速度与成本优化
                </li>
              </ul>
            </li>
            <li>
              <strong>3. 保存设置：</strong>
              设置会自动保存到本地，下次使用时无需重新配置
            </li>
            <li>
              <strong>4. 隐私安全：</strong>
              所有设置仅存储在本地浏览器中，不会上传到服务器
            </li>
          </ul>
        </div>
      </div>
